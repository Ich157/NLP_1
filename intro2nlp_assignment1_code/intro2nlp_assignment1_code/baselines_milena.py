...
if __name__ == '__main__':
    train_path = "data/preprocessed/spanish/train/"
    dev_path = "data/preprocessed/spanish/val/"
    test_path = "data/preprocessed/spanish/test/"
    ...
    length_accuracy_test, length_predictions = length_baseline(train_sentences, train_labels, testinput, testlabels,8)
    ...
    length_accuracy_dev, length_predictions = length_baseline(train_sentences, train_labels, dev_sentences, dev_labels,8)
